                                ...
                                <ul className=' p-2 flex justify-around md:flex-col md:justify-normal gap-4'>
                                    <Link to="/">
                                        <li className={` p-2 rounded flex items-center gap-4 transition-all duration-200
                                            ${location.pathname === '/' ? 'bg-none md:bg-[#2b2b2b]' : 'hover:bg-[#2b2b2b]'}`}>
                                    ...
                                    <Link to="/explore">
                                        <li className={`p-2 rounded flex items-center gap-4 transition-all duration-200
                                            ${location.pathname === '/explore' ? 'bg-none md:bg-[#2b2b2b]' : 'hover:bg-[#2b2b2b]'}`}>
                                    ...
                                    <Link to="/library">
                                        <li className={` p-2 rounded flex items-center gap-4 transition-all duration-200
                                            ${location.pathname === '/library' ? 'bg-none md:bg-[#2b2b2b]' : 'hover:bg-[#2b2b2b]'} `}>
                                    ...
                                    <Link to="/upgrade">
                                        <li className={` p-2 rounded flex items-center gap-4 transition-all duration-200
                                            ${location.pathname === '/upgrade' ? 'bg-none md:bg-[#2b2b2b]' : 'hover:bg-[#2b2b2b]'}`}>
